...
/* city that has the best customers, query that returns one city that has the highest sum of invoice totals. 
...
/*  the artists who have written the most rock music. 
